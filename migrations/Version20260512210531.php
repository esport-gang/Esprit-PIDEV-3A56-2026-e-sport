 ...
 */
final class Version20260512210531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_BA388B7A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE cart_item (id INT AUTO_INCREMENT NOT NULL, quantity INT DEFAULT NULL, added_at DATETIME DEFAULT NULL, cart_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_F0FE25271AD5CDBF (cart_id), INDEX IDX_F0FE25274584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE stream (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(255) NOT NULL, active TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, path LONGTEXT NOT NULL, public_id VARCHAR(255) DEFAULT NULL, thumbnail VARCHAR(500) DEFAULT NULL, reactions_count INT NOT NULL, comments_count INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE video_comment (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, body LONGTEXT NOT NULL, created_at DATETIME NOT NULL, video_id INT NOT NULL, INDEX IDX_7199BBC129C1004E (video_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE video_reaction (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, type VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL, video_id INT NOT NULL, INDEX IDX_C55354B29C1004E (video_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE video_comment ADD CONSTRAINT FK_7199BBC129C1004E FOREIGN KEY (video_id) REFERENCES video (id)');
        $this->addSql('ALTER TABLE video_reaction ADD CONSTRAINT FK_C55354B29C1004E FOREIGN KEY (video_id) REFERENCES video (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video_comment DROP FOREIGN KEY FK_7199BBC129C1004E');
        $this->addSql('ALTER TABLE video_reaction DROP FOREIGN KEY FK_C55354B29C1004E');
